...
number=int("+6285974810517")

devoloper_info={
    
"Developer" :  'ZeroStore',
    "Number" : '+6285974810517',
    "Status" :  'Zero Store',
    }
...
def main():
    ...
    space()
    dual("Selamat datang di Zero store cracking","y.mp3")
...
def numb():
    ...
    print(n2)
    space()
    print("    [bold red]CODE               [bold yellow] ✓ [bold green]Example 087,085,082 ")
    code=input("                        ✓ Choice ->")
